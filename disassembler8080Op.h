...
int Disassemble8080Op(unsigned char *codebuffer, int pc){
    ...
    switch(*code){
        ...
        case 0x01: printf("LXI B-C, #$%02x%02x02x", code[2], code[1]); opbytes = 3; break;
        ...
        case 0x06: printf("MVI B #$%02x%02x02x", code[2], code[1]); opbytes = 2; break;
        ...
        case 0x0e: printf("MVI C #$%02x%02x02x", code[2], code[1]); opbytes = 2; break;
        case 0x0f: printf("RRC"); opbytes = 1; break;
        case 0x11: printf("LXI D-E, #$%02x%02x02x", code[2], code[1]); opbytes = 3; break;
        ...
        case 0x16: printf("MVI D #$%02x%02x02x", code[2], code[1]); opbytes = 2; break;
        ...
        case 0xc3: printf("JMP addr"); opbytes = 3; break;
        ...
        case 0xcd: printf("CALL addr"); opbytes = 3; break;
